package com.example.administrator.xsltest.Game.Link;

import java.util.Timer;
import java.util.TimerTask;
/*
import xslPackage.XslTest.R;
import xslPackage.XslTest.Game.Link.board.GameService;
import xslPackage.XslTest.Game.Link.impl.GameServiceImpl;
import xslPackage.XslTest.Game.Link.object.GameConf;
import xslPackage.XslTest.Game.Link.object.LinkInfo;
import xslPackage.XslTest.Game.Link.view.GameView;
import xslPackage.XslTest.Game.Link.view.Piece;
*/
...
import com.example.administrator.xsltest.Game.Link.board.GameService;
import com.example.administrator.xsltest.Game.Link.impl.GameServiceImpl;
import com.example.administrator.xsltest.Game.Link.object.GameConf;
import com.example.administrator.xsltest.Game.Link.object.LinkInfo;
import com.example.administrator.xsltest.Game.Link.view.GameView;
import com.example.administrator.xsltest.Game.Link.view.Piece;
...
public class Link extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.game_link);
		// 初始化界面
		init();
	}
