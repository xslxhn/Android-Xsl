...
public class book_Main extends Activity {
		...
		mainMenuGrid.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				case 5:// 后退操作
					...
					break;
				case 6:// 测试
					CommonUtil.Log_Info("book", "测试-删除表");
					// 新建100个联系人表
					// ---删除表
					...
					CommonUtil.Log_Info("book", "测试:新建表开始");
					new Thread() {
						String str;
						...
						public void run() {
							...
							for (int i = 1; (i <= maxprogress)
								...
								CommonUtil.Log_Info("book", "测试:" + str);
								// 弹出进度条
								mProgressHandler.sendEmptyMessage(ProgressTag);
							}
							CommonUtil.Log_Info("book", "测试:新建表结束");
						}
					}.start();
	...
	protected void delete(final boolean Bz_DeleteAll,
		...
		if (deleteid == null || deleteid.size() == 0) {
			CommonUtil.Alert(book_Main.this, text1);
		} else {
					...
					.setPositiveButton("确定",
							new DialogInterface.OnClickListener() {
								...
								private void DelStudent(ArrayList<Integer> index) {
									...
									if (isOk) {
										CommonUtil.Alert(book_Main.this,
												"删除成功!");
	...
	protected void BackUp() {
		...
		if (list == null || list.size() == 0) {
			CommonUtil.Alert(book_Main.this, "没有任何数据！");
		} else {
			new AlertDialog.Builder(book_Main.this)
				...
				.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						...
						if (isOk) {
							...
							CommonUtil.Alert(book_Main.this, "还原失败!");
						}
